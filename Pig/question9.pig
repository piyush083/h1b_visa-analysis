--Ans9) Which are employers who have the highest success rate in petitions more than 70% in petitions and total petions filed more than 1000?
...
data = LOAD '/home/hduser/DataSets/h1b.csv' USING CSVExcelStorage() as 
(s_no:int,
...
joined2= foreach joined generate $0,(float)($1+$2)*100/($3),$3;
joined3= filter joined2 by $1>70 and $2>1000;	--Filter by success-rate greater than 70% and petition count above 1000
final= order joined3 by $1 DESC;
dump final;

STORE final INTO '/home/hduser/ProjectOutputs/question9' USING PigStorage(',');
